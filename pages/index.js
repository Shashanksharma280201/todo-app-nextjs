...
export default function Home() {
  ...
  const addTodo = () => {
    ...
    if (todos) {
      let todosJson = Object.values(JSON.parse(todos))
      ...
      <section class="text-white body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
          ...
          <div class="  bg-gray-800 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            <h2 class="text-white-900 text-lg font-medium title-font mb-5">Add a Todo</h2>
            <div class="relative mb-4">
              <label for="title" class="leading-7 text-sm text-white-600">Todo Title</label>
            ...
            <div class="relative mb-4">
              <label for="desc" class="leading-7 text-sm text-white-600">Todo Text</label>
            ...
            <p class="text-xs text-white-500 mt-3">Literally you probably haven't heard of them jean shorts.</p>
          </div>
        </div>
      </section>
    </div>
